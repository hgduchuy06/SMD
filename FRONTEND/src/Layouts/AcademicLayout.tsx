...
const AcademicLayout: React.FC = () => {
  ...
  const menuItems = [
    { icon: "dashboard", label: "Thống Kê", path: "/academic" },
    { icon: "menu_book", label: "Duyệt Giáo trình", path: "/academic/duyet" },
    {
      icon: "school",
      label: "Chương trình đào tạo",
      path: "/academic/chuongtrinh",
    },
    {
      icon: "query_stats",
      label: "Tran cứu và phân tích",
      path: "/academic/tracuu",
    },
    { icon: "notifications", label: "Thông Báo", path: "/academic/thongbao" },
  ];
