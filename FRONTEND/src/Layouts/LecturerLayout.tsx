...
const LecturerLayout: React.FC = () => {
  ...
  const menuItems = [
    { icon: "menu_book", label: "Quản Lý Giáo Trình", path: "/lecturer" },
    {
      icon: "edit_document",
      label: "Tạo Giáo trình",
      path: "/lecturer/tao",
    },
    { icon: "update", label: "Cập nhật giáo trình", path: "/lecturer/capnhat" },
    {
      icon: "rate_review",
      label: "Phản biện ",
      path: "/lecturer/phanbien",
    },
    { icon: "notifications", label: "Thông Báo", path: "/lecturer/thongbao" },
  ];
