...
const StudentLayout: React.FC = () => {
  ...
  const menuItems = [
    { icon: "search", label: "Tìm kiếm giáo trình", path: "/student" },
    {
      icon: "menu_book",
      label: "Chi tiết giáo trình",
      path: "/student/chitiet",
    },
    {
      icon: "timeline",
      label: "Theo dõi môn học",
      path: "/student/theodoi",
    },
    {
      icon: "report_problem",
      label: "Phản hồi lỗi ",
      path: "/student/phanhoi",
    },
  ];
